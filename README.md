...
- This repository contains my practice exercises and projects from the SoloLearn learning platform.

#### 📁 Repository Contents
##### Bash-Scripting-Practice/
- Bash scripting exercises and examples from SoloLearn's Bash course

- Covering Linux commands, scripting basics, automation, and system administration

#### Sololearn_Python_Practice/
- Python programming practice files from SoloLearn's Python courses
